...
public class vtkXMLTableReader : vtkXMLReader
{
	...
	{
		MRClassNameKey = "class vtkXMLTableReader";
		Methods.RegisterType(Assembly.GetExecutingAssembly(), MRClassNameKey, Type.GetType("Kitware.VTK.vtkXMLTableReader"));
	}
	...
	/// </summary>
	public vtkXMLTableReader(IntPtr rawCppThis, bool callDisposalMethod, bool strong)
	...
	public new static vtkXMLTableReader New()
	{
		...
		uint rawRefCount = 0u;
		IntPtr intPtr = vtkXMLTableReader_New(ref mteStatus, ref mteIndex, ref rawRefCount);
		if (IntPtr.Zero != intPtr)
		{
			result = (vtkXMLTableReader)Methods.CreateWrappedObject(mteStatus, mteIndex, rawRefCount, intPtr, callDisposalMethod: true, out var _);
		}
		return result;
	}
	...
	///             Undocumented Block
	/// </summary>
	public vtkXMLTableReader()
		: base(IntPtr.Zero, callDisposalMethod: false, strong: false)
	{
		uint mteStatus = 0u;
		uint mteIndex = uint.MaxValue;
		uint rawRefCount = 0u;
		IntPtr rawCppThis = vtkXMLTableReader_New(ref mteStatus, ref mteIndex, ref rawRefCount);
	...
	{
		vtkXMLTableReader_CopyOutputInformation_01(GetCppThis(), outInfo?.GetCppThis() ?? default(HandleRef), port);
	}

	[DllImport("Kitware.VTK.IOXML.Unmanaged.dll", CallingConvention = CallingConvention.Cdecl)]
	internal static extern long vtkXMLTableReader_GetNumberOfGenerationsFromBase_02(HandleRef pThis, string type);
	...
	{
		return vtkXMLTableReader_GetNumberOfGenerationsFromBase_02(GetCppThis(), type);
	}

	[DllImport("Kitware.VTK.IOXML.Unmanaged.dll", CallingConvention = CallingConvention.Cdecl)]
	internal static extern long vtkXMLTableReader_GetNumberOfGenerationsFromBaseType_03(string type);
	...
	{
		return vtkXMLTableReader_GetNumberOfGenerationsFromBaseType_03(type);
	}
	...
	{
		return vtkXMLTableReader_GetNumberOfPieces_04(GetCppThis());
	}
	...
	{
		return vtkXMLTableReader_GetNumberOfRows_05(GetCppThis());
	}
	...
	public vtkTable GetOutput()
	{
		...
		uint mteIndex = uint.MaxValue;
		uint rawRefCount = 0u;
		IntPtr intPtr = vtkXMLTableReader_GetOutput_06(GetCppThis(), ref mteStatus, ref mteIndex, ref rawRefCount);
		if (IntPtr.Zero != intPtr)
		{
	...
	public vtkTable GetOutput(int idx)
	{
		...
		uint mteIndex = uint.MaxValue;
		uint rawRefCount = 0u;
		IntPtr intPtr = vtkXMLTableReader_GetOutput_07(GetCppThis(), idx, ref mteStatus, ref mteIndex, ref rawRefCount);
		if (IntPtr.Zero != intPtr)
		{
			vtkTable2 = (vtkTable)Methods.CreateWrappedObject(mteStatus, mteIndex, rawRefCount, intPtr, callDisposalMethod: true, out var found);
			if (found)
	...
	[DllImport("Kitware.VTK.IOXML.Unmanaged.dll", CallingConvention = CallingConvention.Cdecl)]
	internal static extern int vtkXMLTableReader_IsA_08(HandleRef pThis, string type);
	...
	{
		return vtkXMLTableReader_IsA_08(GetCppThis(), type);
	}

	[DllImport("Kitware.VTK.IOXML.Unmanaged.dll", CallingConvention = CallingConvention.Cdecl)]
	internal static extern int vtkXMLTableReader_IsTypeOf_09(string type);
	...
	{
		return vtkXMLTableReader_IsTypeOf_09(type);
	}
	...
	public new vtkXMLTableReader NewInstance()
	{
		...
		uint mteIndex = uint.MaxValue;
		uint rawRefCount = 0u;
		IntPtr intPtr = vtkXMLTableReader_NewInstance_11(GetCppThis(), ref mteStatus, ref mteIndex, ref rawRefCount);
		if (IntPtr.Zero != intPtr)
		{
			result = (vtkXMLTableReader)Methods.CreateWrappedObject(mteStatus, mteIndex, rawRefCount, intPtr, callDisposalMethod: true, out var _);
		}
	...
	{
		vtkXMLTableReader vtkXMLTableReader2 = null;
		uint mteStatus = 0u;
		uint mteIndex = uint.MaxValue;
		uint rawRefCount = 0u;
		IntPtr intPtr = vtkXMLTableReader_SafeDownCast_12(o?.GetCppThis() ?? default(HandleRef), ref mteStatus, ref mteIndex, ref rawRefCount);
		if (IntPtr.Zero != intPtr)
		{
			vtkXMLTableReader2 = (vtkXMLTableReader)Methods.CreateWrappedObject(mteStatus, mteIndex, rawRefCount, intPtr, callDisposalMethod: true, out var found);
			if (found)
			{
				vtkXMLTableReader2.Register(null);
			}
		}
		return vtkXMLTableReader2;
	}
	...
	{
		vtkXMLTableReader_SetupUpdateExtent_13(GetCppThis(), piece, numberOfPieces);
	}
}
