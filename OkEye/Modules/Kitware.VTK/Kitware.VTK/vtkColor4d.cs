...
public class vtkColor4d : WrappedObject
{
	...
	static vtkColor4d()
	{
		MRClassNameKey = "class vtkColor4d";
		Methods.RegisterType(Assembly.GetExecutingAssembly(), MRClassNameKey, Type.GetType("Kitware.VTK.vtkColor4d"));
	}
	...
	/// </summary>
	public vtkColor4d(IntPtr rawCppThis, bool callDisposalMethod, bool strong)
	...
	public vtkColor4d(float a, float b, float c, float d)
		: base(IntPtr.Zero, callDisposalMethod: false, strong: false)
	{
		uint mteStatus = 0u;
		uint mteIndex = uint.MaxValue;
		uint rawRefCount = 0u;
		IntPtr rawCppThis = vtkColor4d_New(ref mteStatus, ref mteIndex, ref rawRefCount, a, b, c, d);
