...
public class vtkVector2i : WrappedObject
{
	...
	static vtkVector2i()
	{
		MRClassNameKey = "class vtkVector2i";
		Methods.RegisterType(Assembly.GetExecutingAssembly(), MRClassNameKey, Type.GetType("Kitware.VTK.vtkVector2i"));
	}
	...
	/// </summary>
	public vtkVector2i(IntPtr rawCppThis, bool callDisposalMethod, bool strong)
	...
	public vtkVector2i Normalized()
	{
		...
		uint rawRefCount = 0u;
		IntPtr intPtr = vtkVector2i_Normalized_01(GetCppThis(), ref mteStatus, ref mteIndex, ref rawRefCount);
	...
	public vtkVector2i(float x, float y)
		: base(IntPtr.Zero, callDisposalMethod: false, strong: false)
	{
		uint mteStatus = 0u;
		uint mteIndex = uint.MaxValue;
		uint rawRefCount = 0u;
		IntPtr rawCppThis = vtkVector2i_New(ref mteStatus, ref mteIndex, ref rawRefCount, x, y);
