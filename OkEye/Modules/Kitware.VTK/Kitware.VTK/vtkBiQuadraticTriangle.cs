...
public class vtkBiQuadraticTriangle : vtkNonLinearCell
{
	...
	{
		MRClassNameKey = "class vtkBiQuadraticTriangle";
		Methods.RegisterType(Assembly.GetExecutingAssembly(), MRClassNameKey, Type.GetType("Kitware.VTK.vtkBiQuadraticTriangle"));
	}
	...
	/// </summary>
	public vtkBiQuadraticTriangle(IntPtr rawCppThis, bool callDisposalMethod, bool strong)
	...
	public new static vtkBiQuadraticTriangle New()
	{
		...
		uint rawRefCount = 0u;
		IntPtr intPtr = vtkBiQuadraticTriangle_New(ref mteStatus, ref mteIndex, ref rawRefCount);
		if (IntPtr.Zero != intPtr)
		{
			result = (vtkBiQuadraticTriangle)Methods.CreateWrappedObject(mteStatus, mteIndex, rawRefCount, intPtr, callDisposalMethod: true, out var _);
		}
		return result;
	}
	...
	///             Undocumented Block
	/// </summary>
	public vtkBiQuadraticTriangle()
		: base(IntPtr.Zero, callDisposalMethod: false, strong: false)
	{
		uint mteStatus = 0u;
		uint mteIndex = uint.MaxValue;
		uint rawRefCount = 0u;
		IntPtr rawCppThis = vtkBiQuadraticTriangle_New(ref mteStatus, ref mteIndex, ref rawRefCount);
	...
	{
		return vtkBiQuadraticTriangle_CellBoundary_01(GetCppThis(), subId, pcoords, pts?.GetCppThis() ?? default(HandleRef));
	}
	...
	{
		vtkBiQuadraticTriangle_Clip_02(GetCppThis(), value, cellScalars?.GetCppThis() ?? default(HandleRef), locator?.GetCppThis() ?? default(HandleRef), polys?.GetCppThis() ?? default(HandleRef), inPd?.GetCppThis() ?? default(HandleRef), outPd?.GetCppThis() ?? default(HandleRef), inCd?.GetCppThis() ?? default(HandleRef), cellId, outCd?.GetCppThis() ?? default(HandleRef), insideOut);
	}
	...
	{
		vtkBiQuadraticTriangle_Contour_03(GetCppThis(), value, cellScalars?.GetCppThis() ?? default(HandleRef), locator?.GetCppThis() ?? default(HandleRef), verts?.GetCppThis() ?? default(HandleRef), lines?.GetCppThis() ?? default(HandleRef), polys?.GetCppThis() ?? default(HandleRef), inPd?.GetCppThis() ?? default(HandleRef), outPd?.GetCppThis() ?? default(HandleRef), inCd?.GetCppThis() ?? default(HandleRef), cellId, outCd?.GetCppThis() ?? default(HandleRef));
	}
	...
	{
		vtkBiQuadraticTriangle_Derivatives_04(GetCppThis(), subId, pcoords, values, dim, derivs);
	}
	...
	{
		vtkBiQuadraticTriangle_EvaluateLocation_05(GetCppThis(), ref subId, pcoords, x, weights);
	}
	...
	{
		return vtkBiQuadraticTriangle_EvaluatePosition_06(GetCppThis(), x, closestPoint, ref subId, pcoords, ref dist2, weights);
	}
	...
	{
		return vtkBiQuadraticTriangle_GetCellDimension_07(GetCppThis());
	}
	...
	{
		return vtkBiQuadraticTriangle_GetCellType_08(GetCppThis());
	}
	...
	public override vtkCell GetEdge(int edgeId)
	{
		...
		uint mteIndex = uint.MaxValue;
		uint rawRefCount = 0u;
		IntPtr intPtr = vtkBiQuadraticTriangle_GetEdge_09(GetCppThis(), edgeId, ref mteStatus, ref mteIndex, ref rawRefCount);
		if (IntPtr.Zero != intPtr)
		{
	...
	public override vtkCell GetFace(int arg0)
	{
		...
		uint mteIndex = uint.MaxValue;
		uint rawRefCount = 0u;
		IntPtr intPtr = vtkBiQuadraticTriangle_GetFace_10(GetCppThis(), arg0, ref mteStatus, ref mteIndex, ref rawRefCount);
		if (IntPtr.Zero != intPtr)
		{
			vtkCell2 = (vtkCell)Methods.CreateWrappedObject(mteStatus, mteIndex, rawRefCount, intPtr, callDisposalMethod: true, out var found);
			if (found)
	...
	{
		return vtkBiQuadraticTriangle_GetNumberOfEdges_11(GetCppThis());
	}
	...
	{
		return vtkBiQuadraticTriangle_GetNumberOfFaces_12(GetCppThis());
	}

	[DllImport("Kitware.VTK.CommonDataModel.Unmanaged.dll", CallingConvention = CallingConvention.Cdecl)]
	internal static extern long vtkBiQuadraticTriangle_GetNumberOfGenerationsFromBase_13(HandleRef pThis, string type);
	...
	{
		return vtkBiQuadraticTriangle_GetNumberOfGenerationsFromBase_13(GetCppThis(), type);
	}

	[DllImport("Kitware.VTK.CommonDataModel.Unmanaged.dll", CallingConvention = CallingConvention.Cdecl)]
	internal static extern long vtkBiQuadraticTriangle_GetNumberOfGenerationsFromBaseType_14(string type);
	...
	{
		return vtkBiQuadraticTriangle_GetNumberOfGenerationsFromBaseType_14(type);
	}
	...
	{
		return vtkBiQuadraticTriangle_GetParametricCenter_15(GetCppThis(), pcoords);
	}
	...
	{
		return vtkBiQuadraticTriangle_GetParametricCoords_16(GetCppThis());
	}
	...
	{
		return vtkBiQuadraticTriangle_GetParametricDistance_17(GetCppThis(), pcoords);
	}
	...
	{
		vtkBiQuadraticTriangle_InterpolateDerivs_18(GetCppThis(), pcoords, derivs);
	}
	...
	{
		vtkBiQuadraticTriangle_InterpolateFunctions_19(GetCppThis(), pcoords, weights);
	}
	...
	{
		vtkBiQuadraticTriangle_InterpolationDerivs_20(pcoords, derivs);
	}
	...
	{
		vtkBiQuadraticTriangle_InterpolationFunctions_21(pcoords, weights);
	}
	...
	{
		return vtkBiQuadraticTriangle_IntersectWithLine_22(GetCppThis(), p1, p2, tol, ref t, x, pcoords, ref subId);
	}

	[DllImport("Kitware.VTK.CommonDataModel.Unmanaged.dll", CallingConvention = CallingConvention.Cdecl)]
	internal static extern int vtkBiQuadraticTriangle_IsA_23(HandleRef pThis, string type);
	...
	{
		return vtkBiQuadraticTriangle_IsA_23(GetCppThis(), type);
	}

	[DllImport("Kitware.VTK.CommonDataModel.Unmanaged.dll", CallingConvention = CallingConvention.Cdecl)]
	internal static extern int vtkBiQuadraticTriangle_IsTypeOf_24(string type);
	...
	{
		return vtkBiQuadraticTriangle_IsTypeOf_24(type);
	}
	...
	public new vtkBiQuadraticTriangle NewInstance()
	{
		...
		uint mteIndex = uint.MaxValue;
		uint rawRefCount = 0u;
		IntPtr intPtr = vtkBiQuadraticTriangle_NewInstance_26(GetCppThis(), ref mteStatus, ref mteIndex, ref rawRefCount);
		if (IntPtr.Zero != intPtr)
		{
			result = (vtkBiQuadraticTriangle)Methods.CreateWrappedObject(mteStatus, mteIndex, rawRefCount, intPtr, callDisposalMethod: true, out var _);
		}
	...
	{
		vtkBiQuadraticTriangle vtkBiQuadraticTriangle2 = null;
		uint mteStatus = 0u;
		uint mteIndex = uint.MaxValue;
		uint rawRefCount = 0u;
		IntPtr intPtr = vtkBiQuadraticTriangle_SafeDownCast_27(o?.GetCppThis() ?? default(HandleRef), ref mteStatus, ref mteIndex, ref rawRefCount);
		if (IntPtr.Zero != intPtr)
		{
			vtkBiQuadraticTriangle2 = (vtkBiQuadraticTriangle)Methods.CreateWrappedObject(mteStatus, mteIndex, rawRefCount, intPtr, callDisposalMethod: true, out var found);
			if (found)
			{
				vtkBiQuadraticTriangle2.Register(null);
			}
		}
		return vtkBiQuadraticTriangle2;
	}

	[DllImport("Kitware.VTK.CommonDataModel.Unmanaged.dll", CallingConvention = CallingConvention.Cdecl)]
	internal static extern int vtkBiQuadraticTriangle_Triangulate_28(HandleRef pThis, int index, HandleRef ptIds, HandleRef pts);
	...
	{
		return vtkBiQuadraticTriangle_Triangulate_28(GetCppThis(), index, ptIds?.GetCppThis() ?? default(HandleRef), pts?.GetCppThis() ?? default(HandleRef));
	}
}
