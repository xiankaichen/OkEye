...
public class vtkPassInputTypeAlgorithm : vtkAlgorithm
{
	...
	{
		MRClassNameKey = "class vtkPassInputTypeAlgorithm";
		Methods.RegisterType(Assembly.GetExecutingAssembly(), MRClassNameKey, Type.GetType("Kitware.VTK.vtkPassInputTypeAlgorithm"));
	}
	...
	/// </summary>
	public vtkPassInputTypeAlgorithm(IntPtr rawCppThis, bool callDisposalMethod, bool strong)
	...
	public new static vtkPassInputTypeAlgorithm New()
	{
		...
		uint rawRefCount = 0u;
		IntPtr intPtr = vtkPassInputTypeAlgorithm_New(ref mteStatus, ref mteIndex, ref rawRefCount);
		if (IntPtr.Zero != intPtr)
		{
			result = (vtkPassInputTypeAlgorithm)Methods.CreateWrappedObject(mteStatus, mteIndex, rawRefCount, intPtr, callDisposalMethod: true, out var _);
		}
		return result;
	}
		...
		: base(IntPtr.Zero, callDisposalMethod: false, strong: false)
	{
		...
		uint mteIndex = uint.MaxValue;
		uint rawRefCount = 0u;
		IntPtr rawCppThis = vtkPassInputTypeAlgorithm_New(ref mteStatus, ref mteIndex, ref rawRefCount);
	...
	{
		vtkPassInputTypeAlgorithm_AddInputData_01(GetCppThis(), arg0?.GetCppThis() ?? default(HandleRef));
	}
	...
	{
		vtkPassInputTypeAlgorithm_AddInputData_02(GetCppThis(), arg0, arg1?.GetCppThis() ?? default(HandleRef));
	}
	...
	public vtkGraph GetGraphOutput()
	{
		...
		uint mteIndex = uint.MaxValue;
		uint rawRefCount = 0u;
		IntPtr intPtr = vtkPassInputTypeAlgorithm_GetGraphOutput_03(GetCppThis(), ref mteStatus, ref mteIndex, ref rawRefCount);
		if (IntPtr.Zero != intPtr)
		{
	...
	public vtkImageData GetImageDataOutput()
	{
		...
		uint mteIndex = uint.MaxValue;
		uint rawRefCount = 0u;
		IntPtr intPtr = vtkPassInputTypeAlgorithm_GetImageDataOutput_04(GetCppThis(), ref mteStatus, ref mteIndex, ref rawRefCount);
		if (IntPtr.Zero != intPtr)
		{
	...
	public vtkDataObject GetInput()
	{
		...
		uint mteIndex = uint.MaxValue;
		uint rawRefCount = 0u;
		IntPtr intPtr = vtkPassInputTypeAlgorithm_GetInput_05(GetCppThis(), ref mteStatus, ref mteIndex, ref rawRefCount);
		if (IntPtr.Zero != intPtr)
		{
	...
	public vtkMolecule GetMoleculeOutput()
	{
		...
		uint mteIndex = uint.MaxValue;
		uint rawRefCount = 0u;
		IntPtr intPtr = vtkPassInputTypeAlgorithm_GetMoleculeOutput_06(GetCppThis(), ref mteStatus, ref mteIndex, ref rawRefCount);
		if (IntPtr.Zero != intPtr)
		{
	...
	[DllImport("Kitware.VTK.CommonExecutionModel.Unmanaged.dll", CallingConvention = CallingConvention.Cdecl)]
	internal static extern long vtkPassInputTypeAlgorithm_GetNumberOfGenerationsFromBase_07(HandleRef pThis, string type);
	...
	{
		return vtkPassInputTypeAlgorithm_GetNumberOfGenerationsFromBase_07(GetCppThis(), type);
	}

	[DllImport("Kitware.VTK.CommonExecutionModel.Unmanaged.dll", CallingConvention = CallingConvention.Cdecl)]
	internal static extern long vtkPassInputTypeAlgorithm_GetNumberOfGenerationsFromBaseType_08(string type);
	...
	{
		return vtkPassInputTypeAlgorithm_GetNumberOfGenerationsFromBaseType_08(type);
	}
	...
	public vtkDataObject GetOutput()
	{
		...
		uint mteIndex = uint.MaxValue;
		uint rawRefCount = 0u;
		IntPtr intPtr = vtkPassInputTypeAlgorithm_GetOutput_09(GetCppThis(), ref mteStatus, ref mteIndex, ref rawRefCount);
		if (IntPtr.Zero != intPtr)
		{
			vtkDataObject2 = (vtkDataObject)Methods.CreateWrappedObject(mteStatus, mteIndex, rawRefCount, intPtr, callDisposalMethod: true, out var found);
			if (found)
	...
	public vtkDataObject GetOutput(int arg0)
	{
		...
		uint mteIndex = uint.MaxValue;
		uint rawRefCount = 0u;
		IntPtr intPtr = vtkPassInputTypeAlgorithm_GetOutput_10(GetCppThis(), arg0, ref mteStatus, ref mteIndex, ref rawRefCount);
		if (IntPtr.Zero != intPtr)
		{
			vtkDataObject2 = (vtkDataObject)Methods.CreateWrappedObject(mteStatus, mteIndex, rawRefCount, intPtr, callDisposalMethod: true, out var found);
			if (found)
	...
	public vtkPolyData GetPolyDataOutput()
	{
		...
		uint mteIndex = uint.MaxValue;
		uint rawRefCount = 0u;
		IntPtr intPtr = vtkPassInputTypeAlgorithm_GetPolyDataOutput_11(GetCppThis(), ref mteStatus, ref mteIndex, ref rawRefCount);
		if (IntPtr.Zero != intPtr)
		{
	...
	public vtkRectilinearGrid GetRectilinearGridOutput()
	{
		...
		uint mteIndex = uint.MaxValue;
		uint rawRefCount = 0u;
		IntPtr intPtr = vtkPassInputTypeAlgorithm_GetRectilinearGridOutput_12(GetCppThis(), ref mteStatus, ref mteIndex, ref rawRefCount);
		if (IntPtr.Zero != intPtr)
		{
	...
	public vtkStructuredGrid GetStructuredGridOutput()
	{
		...
		uint mteIndex = uint.MaxValue;
		uint rawRefCount = 0u;
		IntPtr intPtr = vtkPassInputTypeAlgorithm_GetStructuredGridOutput_13(GetCppThis(), ref mteStatus, ref mteIndex, ref rawRefCount);
		if (IntPtr.Zero != intPtr)
		{
	...
	public vtkStructuredPoints GetStructuredPointsOutput()
	{
		...
		uint mteIndex = uint.MaxValue;
		uint rawRefCount = 0u;
		IntPtr intPtr = vtkPassInputTypeAlgorithm_GetStructuredPointsOutput_14(GetCppThis(), ref mteStatus, ref mteIndex, ref rawRefCount);
		if (IntPtr.Zero != intPtr)
		{
	...
	public vtkTable GetTableOutput()
	{
		...
		uint mteIndex = uint.MaxValue;
		uint rawRefCount = 0u;
		IntPtr intPtr = vtkPassInputTypeAlgorithm_GetTableOutput_15(GetCppThis(), ref mteStatus, ref mteIndex, ref rawRefCount);
		if (IntPtr.Zero != intPtr)
		{
	...
	public vtkUnstructuredGrid GetUnstructuredGridOutput()
	{
		...
		uint mteIndex = uint.MaxValue;
		uint rawRefCount = 0u;
		IntPtr intPtr = vtkPassInputTypeAlgorithm_GetUnstructuredGridOutput_16(GetCppThis(), ref mteStatus, ref mteIndex, ref rawRefCount);
		if (IntPtr.Zero != intPtr)
		{
	...
	[DllImport("Kitware.VTK.CommonExecutionModel.Unmanaged.dll", CallingConvention = CallingConvention.Cdecl)]
	internal static extern int vtkPassInputTypeAlgorithm_IsA_17(HandleRef pThis, string type);
	...
	{
		return vtkPassInputTypeAlgorithm_IsA_17(GetCppThis(), type);
	}

	[DllImport("Kitware.VTK.CommonExecutionModel.Unmanaged.dll", CallingConvention = CallingConvention.Cdecl)]
	internal static extern int vtkPassInputTypeAlgorithm_IsTypeOf_18(string type);
	...
	{
		return vtkPassInputTypeAlgorithm_IsTypeOf_18(type);
	}
	...
	public new vtkPassInputTypeAlgorithm NewInstance()
	{
		...
		uint mteIndex = uint.MaxValue;
		uint rawRefCount = 0u;
		IntPtr intPtr = vtkPassInputTypeAlgorithm_NewInstance_20(GetCppThis(), ref mteStatus, ref mteIndex, ref rawRefCount);
		if (IntPtr.Zero != intPtr)
		{
			result = (vtkPassInputTypeAlgorithm)Methods.CreateWrappedObject(mteStatus, mteIndex, rawRefCount, intPtr, callDisposalMethod: true, out var _);
		}
	...
	{
		vtkPassInputTypeAlgorithm vtkPassInputTypeAlgorithm2 = null;
		uint mteStatus = 0u;
		uint mteIndex = uint.MaxValue;
		uint rawRefCount = 0u;
		IntPtr intPtr = vtkPassInputTypeAlgorithm_SafeDownCast_21(o?.GetCppThis() ?? default(HandleRef), ref mteStatus, ref mteIndex, ref rawRefCount);
		if (IntPtr.Zero != intPtr)
		{
			vtkPassInputTypeAlgorithm2 = (vtkPassInputTypeAlgorithm)Methods.CreateWrappedObject(mteStatus, mteIndex, rawRefCount, intPtr, callDisposalMethod: true, out var found);
			if (found)
			{
				vtkPassInputTypeAlgorithm2.Register(null);
			}
		}
		return vtkPassInputTypeAlgorithm2;
	}
	...
	{
		vtkPassInputTypeAlgorithm_SetInputData_22(GetCppThis(), arg0?.GetCppThis() ?? default(HandleRef));
	}
	...
	{
		vtkPassInputTypeAlgorithm_SetInputData_23(GetCppThis(), arg0, arg1?.GetCppThis() ?? default(HandleRef));
	}
}
