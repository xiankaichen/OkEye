...
public class vtkPointSetAlgorithm : vtkAlgorithm
{
	...
	{
		MRClassNameKey = "class vtkPointSetAlgorithm";
		Methods.RegisterType(Assembly.GetExecutingAssembly(), MRClassNameKey, Type.GetType("Kitware.VTK.vtkPointSetAlgorithm"));
	}
	...
	/// </summary>
	public vtkPointSetAlgorithm(IntPtr rawCppThis, bool callDisposalMethod, bool strong)
	...
	public new static vtkPointSetAlgorithm New()
	{
		...
		uint rawRefCount = 0u;
		IntPtr intPtr = vtkPointSetAlgorithm_New(ref mteStatus, ref mteIndex, ref rawRefCount);
		if (IntPtr.Zero != intPtr)
		{
			result = (vtkPointSetAlgorithm)Methods.CreateWrappedObject(mteStatus, mteIndex, rawRefCount, intPtr, callDisposalMethod: true, out var _);
		}
		return result;
	}
		...
		: base(IntPtr.Zero, callDisposalMethod: false, strong: false)
	{
		...
		uint mteIndex = uint.MaxValue;
		uint rawRefCount = 0u;
		IntPtr rawCppThis = vtkPointSetAlgorithm_New(ref mteStatus, ref mteIndex, ref rawRefCount);
	...
	{
		vtkPointSetAlgorithm_AddInputData_01(GetCppThis(), arg0?.GetCppThis() ?? default(HandleRef));
	}
	...
	{
		vtkPointSetAlgorithm_AddInputData_02(GetCppThis(), arg0?.GetCppThis() ?? default(HandleRef));
	}
	...
	{
		vtkPointSetAlgorithm_AddInputData_03(GetCppThis(), arg0, arg1?.GetCppThis() ?? default(HandleRef));
	}
	...
	{
		vtkPointSetAlgorithm_AddInputData_04(GetCppThis(), arg0, arg1?.GetCppThis() ?? default(HandleRef));
	}
	...
	public vtkDataObject GetInput()
	{
		...
		uint mteIndex = uint.MaxValue;
		uint rawRefCount = 0u;
		IntPtr intPtr = vtkPointSetAlgorithm_GetInput_05(GetCppThis(), ref mteStatus, ref mteIndex, ref rawRefCount);
		if (IntPtr.Zero != intPtr)
		{
	...
	[DllImport("Kitware.VTK.CommonExecutionModel.Unmanaged.dll", CallingConvention = CallingConvention.Cdecl)]
	internal static extern long vtkPointSetAlgorithm_GetNumberOfGenerationsFromBase_06(HandleRef pThis, string type);
	...
	{
		return vtkPointSetAlgorithm_GetNumberOfGenerationsFromBase_06(GetCppThis(), type);
	}

	[DllImport("Kitware.VTK.CommonExecutionModel.Unmanaged.dll", CallingConvention = CallingConvention.Cdecl)]
	internal static extern long vtkPointSetAlgorithm_GetNumberOfGenerationsFromBaseType_07(string type);
	...
	{
		return vtkPointSetAlgorithm_GetNumberOfGenerationsFromBaseType_07(type);
	}
	...
	public vtkPointSet GetOutput()
	{
		...
		uint mteIndex = uint.MaxValue;
		uint rawRefCount = 0u;
		IntPtr intPtr = vtkPointSetAlgorithm_GetOutput_08(GetCppThis(), ref mteStatus, ref mteIndex, ref rawRefCount);
		if (IntPtr.Zero != intPtr)
		{
	...
	public vtkPointSet GetOutput(int arg0)
	{
		...
		uint mteIndex = uint.MaxValue;
		uint rawRefCount = 0u;
		IntPtr intPtr = vtkPointSetAlgorithm_GetOutput_09(GetCppThis(), arg0, ref mteStatus, ref mteIndex, ref rawRefCount);
		if (IntPtr.Zero != intPtr)
		{
			vtkPointSet2 = (vtkPointSet)Methods.CreateWrappedObject(mteStatus, mteIndex, rawRefCount, intPtr, callDisposalMethod: true, out var found);
			if (found)
	...
	public vtkPolyData GetPolyDataOutput()
	{
		...
		uint mteIndex = uint.MaxValue;
		uint rawRefCount = 0u;
		IntPtr intPtr = vtkPointSetAlgorithm_GetPolyDataOutput_10(GetCppThis(), ref mteStatus, ref mteIndex, ref rawRefCount);
		if (IntPtr.Zero != intPtr)
		{
	...
	public vtkStructuredGrid GetStructuredGridOutput()
	{
		...
		uint mteIndex = uint.MaxValue;
		uint rawRefCount = 0u;
		IntPtr intPtr = vtkPointSetAlgorithm_GetStructuredGridOutput_11(GetCppThis(), ref mteStatus, ref mteIndex, ref rawRefCount);
		if (IntPtr.Zero != intPtr)
		{
	...
	public vtkUnstructuredGrid GetUnstructuredGridOutput()
	{
		...
		uint mteIndex = uint.MaxValue;
		uint rawRefCount = 0u;
		IntPtr intPtr = vtkPointSetAlgorithm_GetUnstructuredGridOutput_12(GetCppThis(), ref mteStatus, ref mteIndex, ref rawRefCount);
		if (IntPtr.Zero != intPtr)
		{
	...
	[DllImport("Kitware.VTK.CommonExecutionModel.Unmanaged.dll", CallingConvention = CallingConvention.Cdecl)]
	internal static extern int vtkPointSetAlgorithm_IsA_13(HandleRef pThis, string type);
	...
	{
		return vtkPointSetAlgorithm_IsA_13(GetCppThis(), type);
	}

	[DllImport("Kitware.VTK.CommonExecutionModel.Unmanaged.dll", CallingConvention = CallingConvention.Cdecl)]
	internal static extern int vtkPointSetAlgorithm_IsTypeOf_14(string type);
	...
	{
		return vtkPointSetAlgorithm_IsTypeOf_14(type);
	}
	...
	public new vtkPointSetAlgorithm NewInstance()
	{
		...
		uint mteIndex = uint.MaxValue;
		uint rawRefCount = 0u;
		IntPtr intPtr = vtkPointSetAlgorithm_NewInstance_16(GetCppThis(), ref mteStatus, ref mteIndex, ref rawRefCount);
		if (IntPtr.Zero != intPtr)
		{
			result = (vtkPointSetAlgorithm)Methods.CreateWrappedObject(mteStatus, mteIndex, rawRefCount, intPtr, callDisposalMethod: true, out var _);
		}
	...
	{
		vtkPointSetAlgorithm vtkPointSetAlgorithm2 = null;
		uint mteStatus = 0u;
		uint mteIndex = uint.MaxValue;
		uint rawRefCount = 0u;
		IntPtr intPtr = vtkPointSetAlgorithm_SafeDownCast_17(o?.GetCppThis() ?? default(HandleRef), ref mteStatus, ref mteIndex, ref rawRefCount);
		if (IntPtr.Zero != intPtr)
		{
			vtkPointSetAlgorithm2 = (vtkPointSetAlgorithm)Methods.CreateWrappedObject(mteStatus, mteIndex, rawRefCount, intPtr, callDisposalMethod: true, out var found);
			if (found)
			{
				vtkPointSetAlgorithm2.Register(null);
			}
		}
		return vtkPointSetAlgorithm2;
	}
	...
	{
		vtkPointSetAlgorithm_SetInputData_18(GetCppThis(), arg0?.GetCppThis() ?? default(HandleRef));
	}
	...
	{
		vtkPointSetAlgorithm_SetInputData_19(GetCppThis(), arg0, arg1?.GetCppThis() ?? default(HandleRef));
	}
	...
	{
		vtkPointSetAlgorithm_SetInputData_20(GetCppThis(), arg0?.GetCppThis() ?? default(HandleRef));
	}
	...
	{
		vtkPointSetAlgorithm_SetInputData_21(GetCppThis(), arg0, arg1?.GetCppThis() ?? default(HandleRef));
	}
}
