...
public class vtkVector2f : WrappedObject
{
	...
	static vtkVector2f()
	{
		MRClassNameKey = "class vtkVector2f";
		Methods.RegisterType(Assembly.GetExecutingAssembly(), MRClassNameKey, Type.GetType("Kitware.VTK.vtkVector2f"));
	}
	...
	/// </summary>
	public vtkVector2f(IntPtr rawCppThis, bool callDisposalMethod, bool strong)
	...
	public vtkVector2f Normalized()
	{
		...
		uint rawRefCount = 0u;
		IntPtr intPtr = vtkVector2f_Normalized_01(GetCppThis(), ref mteStatus, ref mteIndex, ref rawRefCount);
	...
	public vtkVector2f(float x, float y)
		: base(IntPtr.Zero, callDisposalMethod: false, strong: false)
	{
		uint mteStatus = 0u;
		uint mteIndex = uint.MaxValue;
		uint rawRefCount = 0u;
		IntPtr rawCppThis = vtkVector2f_New(ref mteStatus, ref mteIndex, ref rawRefCount, x, y);
