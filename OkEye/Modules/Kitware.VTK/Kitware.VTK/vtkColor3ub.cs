...
public class vtkColor3ub : WrappedObject
{
	...
	static vtkColor3ub()
	{
		MRClassNameKey = "class vtkColor3ub";
		Methods.RegisterType(Assembly.GetExecutingAssembly(), MRClassNameKey, Type.GetType("Kitware.VTK.vtkColor3ub"));
	}
	...
	/// </summary>
	public vtkColor3ub(IntPtr rawCppThis, bool callDisposalMethod, bool strong)
	...
	public vtkColor3ub(float x, float y, float z)
		: base(IntPtr.Zero, callDisposalMethod: false, strong: false)
	{
		uint mteStatus = 0u;
		uint mteIndex = uint.MaxValue;
		uint rawRefCount = 0u;
		IntPtr rawCppThis = vtkColor3ub_New(ref mteStatus, ref mteIndex, ref rawRefCount, x, y, z);
