...
public class vtkBezierTetra : vtkHigherOrderTetra
{
	...
	{
		MRClassNameKey = "class vtkBezierTetra";
		Methods.RegisterType(Assembly.GetExecutingAssembly(), MRClassNameKey, Type.GetType("Kitware.VTK.vtkBezierTetra"));
	}
	...
	/// </summary>
	public vtkBezierTetra(IntPtr rawCppThis, bool callDisposalMethod, bool strong)
	...
	public new static vtkBezierTetra New()
	{
		...
		uint rawRefCount = 0u;
		IntPtr intPtr = vtkBezierTetra_New(ref mteStatus, ref mteIndex, ref rawRefCount);
		if (IntPtr.Zero != intPtr)
		{
			result = (vtkBezierTetra)Methods.CreateWrappedObject(mteStatus, mteIndex, rawRefCount, intPtr, callDisposalMethod: true, out var _);
		}
		return result;
	}
	...
	///             Undocumented Block
	/// </summary>
	public vtkBezierTetra()
		: base(IntPtr.Zero, callDisposalMethod: false, strong: false)
	{
		uint mteStatus = 0u;
		uint mteIndex = uint.MaxValue;
		uint rawRefCount = 0u;
		IntPtr rawCppThis = vtkBezierTetra_New(ref mteStatus, ref mteIndex, ref rawRefCount);
	...
	{
		return vtkBezierTetra_GetCellType_01(GetCppThis());
	}
	...
	public override vtkCell GetEdge(int edgeId)
	{
		...
		uint mteIndex = uint.MaxValue;
		uint rawRefCount = 0u;
		IntPtr intPtr = vtkBezierTetra_GetEdge_02(GetCppThis(), edgeId, ref mteStatus, ref mteIndex, ref rawRefCount);
		if (IntPtr.Zero != intPtr)
		{
	...
	public override vtkHigherOrderCurve GetEdgeCell()
	{
		...
		uint mteIndex = uint.MaxValue;
		uint rawRefCount = 0u;
		IntPtr intPtr = vtkBezierTetra_GetEdgeCell_03(GetCppThis(), ref mteStatus, ref mteIndex, ref rawRefCount);
		if (IntPtr.Zero != intPtr)
		{
	...
	public override vtkCell GetFace(int faceId)
	{
		...
		uint mteIndex = uint.MaxValue;
		uint rawRefCount = 0u;
		IntPtr intPtr = vtkBezierTetra_GetFace_04(GetCppThis(), faceId, ref mteStatus, ref mteIndex, ref rawRefCount);
		if (IntPtr.Zero != intPtr)
		{
			vtkCell2 = (vtkCell)Methods.CreateWrappedObject(mteStatus, mteIndex, rawRefCount, intPtr, callDisposalMethod: true, out var found);
			if (found)
	...
	public override vtkHigherOrderTriangle GetFaceCell()
	{
		...
		uint mteIndex = uint.MaxValue;
		uint rawRefCount = 0u;
		IntPtr intPtr = vtkBezierTetra_GetFaceCell_05(GetCppThis(), ref mteStatus, ref mteIndex, ref rawRefCount);
		if (IntPtr.Zero != intPtr)
		{
	...
	[DllImport("Kitware.VTK.CommonDataModel.Unmanaged.dll", CallingConvention = CallingConvention.Cdecl)]
	internal static extern long vtkBezierTetra_GetNumberOfGenerationsFromBase_06(HandleRef pThis, string type);
	...
	{
		return vtkBezierTetra_GetNumberOfGenerationsFromBase_06(GetCppThis(), type);
	}

	[DllImport("Kitware.VTK.CommonDataModel.Unmanaged.dll", CallingConvention = CallingConvention.Cdecl)]
	internal static extern long vtkBezierTetra_GetNumberOfGenerationsFromBaseType_07(string type);
	...
	{
		return vtkBezierTetra_GetNumberOfGenerationsFromBaseType_07(type);
	}
	...
	public vtkDoubleArray GetRationalWeights()
	{
		...
		uint mteIndex = uint.MaxValue;
		uint rawRefCount = 0u;
		IntPtr intPtr = vtkBezierTetra_GetRationalWeights_08(GetCppThis(), ref mteStatus, ref mteIndex, ref rawRefCount);
		if (IntPtr.Zero != intPtr)
		{
	...
	{
		vtkBezierTetra_InterpolateDerivs_09(GetCppThis(), pcoords, derivs);
	}
	...
	{
		vtkBezierTetra_InterpolateFunctions_10(GetCppThis(), pcoords, weights);
	}

	[DllImport("Kitware.VTK.CommonDataModel.Unmanaged.dll", CallingConvention = CallingConvention.Cdecl)]
	internal static extern int vtkBezierTetra_IsA_11(HandleRef pThis, string type);
	...
	{
		return vtkBezierTetra_IsA_11(GetCppThis(), type);
	}

	[DllImport("Kitware.VTK.CommonDataModel.Unmanaged.dll", CallingConvention = CallingConvention.Cdecl)]
	internal static extern int vtkBezierTetra_IsTypeOf_12(string type);
	...
	{
		return vtkBezierTetra_IsTypeOf_12(type);
	}
	...
	public new vtkBezierTetra NewInstance()
	{
		...
		uint mteIndex = uint.MaxValue;
		uint rawRefCount = 0u;
		IntPtr intPtr = vtkBezierTetra_NewInstance_14(GetCppThis(), ref mteStatus, ref mteIndex, ref rawRefCount);
		if (IntPtr.Zero != intPtr)
		{
			result = (vtkBezierTetra)Methods.CreateWrappedObject(mteStatus, mteIndex, rawRefCount, intPtr, callDisposalMethod: true, out var _);
		}
	...
	{
		vtkBezierTetra vtkBezierTetra2 = null;
		uint mteStatus = 0u;
		uint mteIndex = uint.MaxValue;
		uint rawRefCount = 0u;
		IntPtr intPtr = vtkBezierTetra_SafeDownCast_15(o?.GetCppThis() ?? default(HandleRef), ref mteStatus, ref mteIndex, ref rawRefCount);
		if (IntPtr.Zero != intPtr)
		{
			vtkBezierTetra2 = (vtkBezierTetra)Methods.CreateWrappedObject(mteStatus, mteIndex, rawRefCount, intPtr, callDisposalMethod: true, out var found);
			if (found)
			{
				vtkBezierTetra2.Register(null);
			}
		}
		return vtkBezierTetra2;
	}
	...
	{
		vtkBezierTetra_SetRationalWeightsFromPointData_16(GetCppThis(), point_data?.GetCppThis() ?? default(HandleRef), numPts);
	}
}
