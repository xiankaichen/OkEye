...
public class vtkDataObjectAlgorithm : vtkAlgorithm
{
	...
	{
		MRClassNameKey = "class vtkDataObjectAlgorithm";
		Methods.RegisterType(Assembly.GetExecutingAssembly(), MRClassNameKey, Type.GetType("Kitware.VTK.vtkDataObjectAlgorithm"));
	}
	...
	/// </summary>
	public vtkDataObjectAlgorithm(IntPtr rawCppThis, bool callDisposalMethod, bool strong)
	...
	public new static vtkDataObjectAlgorithm New()
	{
		...
		uint rawRefCount = 0u;
		IntPtr intPtr = vtkDataObjectAlgorithm_New(ref mteStatus, ref mteIndex, ref rawRefCount);
		if (IntPtr.Zero != intPtr)
		{
			result = (vtkDataObjectAlgorithm)Methods.CreateWrappedObject(mteStatus, mteIndex, rawRefCount, intPtr, callDisposalMethod: true, out var _);
		}
		return result;
	}
		...
		: base(IntPtr.Zero, callDisposalMethod: false, strong: false)
	{
		...
		uint mteIndex = uint.MaxValue;
		uint rawRefCount = 0u;
		IntPtr rawCppThis = vtkDataObjectAlgorithm_New(ref mteStatus, ref mteIndex, ref rawRefCount);
	...
	{
		vtkDataObjectAlgorithm_AddInputData_01(GetCppThis(), arg0?.GetCppThis() ?? default(HandleRef));
	}
	...
	{
		vtkDataObjectAlgorithm_AddInputData_02(GetCppThis(), arg0, arg1?.GetCppThis() ?? default(HandleRef));
	}
	...
	public vtkDataObject GetInput()
	{
		...
		uint mteIndex = uint.MaxValue;
		uint rawRefCount = 0u;
		IntPtr intPtr = vtkDataObjectAlgorithm_GetInput_03(GetCppThis(), ref mteStatus, ref mteIndex, ref rawRefCount);
		if (IntPtr.Zero != intPtr)
		{
	...
	public vtkDataObject GetInput(int port)
	{
		...
		uint mteIndex = uint.MaxValue;
		uint rawRefCount = 0u;
		IntPtr intPtr = vtkDataObjectAlgorithm_GetInput_04(GetCppThis(), port, ref mteStatus, ref mteIndex, ref rawRefCount);
		if (IntPtr.Zero != intPtr)
		{
			vtkDataObject2 = (vtkDataObject)Methods.CreateWrappedObject(mteStatus, mteIndex, rawRefCount, intPtr, callDisposalMethod: true, out var found);
			if (found)
	...
	[DllImport("Kitware.VTK.CommonExecutionModel.Unmanaged.dll", CallingConvention = CallingConvention.Cdecl)]
	internal static extern long vtkDataObjectAlgorithm_GetNumberOfGenerationsFromBase_05(HandleRef pThis, string type);
	...
	{
		return vtkDataObjectAlgorithm_GetNumberOfGenerationsFromBase_05(GetCppThis(), type);
	}

	[DllImport("Kitware.VTK.CommonExecutionModel.Unmanaged.dll", CallingConvention = CallingConvention.Cdecl)]
	internal static extern long vtkDataObjectAlgorithm_GetNumberOfGenerationsFromBaseType_06(string type);
	...
	{
		return vtkDataObjectAlgorithm_GetNumberOfGenerationsFromBaseType_06(type);
	}
	...
	public vtkDataObject GetOutput()
	{
		...
		uint mteIndex = uint.MaxValue;
		uint rawRefCount = 0u;
		IntPtr intPtr = vtkDataObjectAlgorithm_GetOutput_07(GetCppThis(), ref mteStatus, ref mteIndex, ref rawRefCount);
		if (IntPtr.Zero != intPtr)
		{
			vtkDataObject2 = (vtkDataObject)Methods.CreateWrappedObject(mteStatus, mteIndex, rawRefCount, intPtr, callDisposalMethod: true, out var found);
			if (found)
	...
	public vtkDataObject GetOutput(int arg0)
	{
		...
		uint mteIndex = uint.MaxValue;
		uint rawRefCount = 0u;
		IntPtr intPtr = vtkDataObjectAlgorithm_GetOutput_08(GetCppThis(), arg0, ref mteStatus, ref mteIndex, ref rawRefCount);
		if (IntPtr.Zero != intPtr)
		{
			vtkDataObject2 = (vtkDataObject)Methods.CreateWrappedObject(mteStatus, mteIndex, rawRefCount, intPtr, callDisposalMethod: true, out var found);
			if (found)
	...
	[DllImport("Kitware.VTK.CommonExecutionModel.Unmanaged.dll", CallingConvention = CallingConvention.Cdecl)]
	internal static extern int vtkDataObjectAlgorithm_IsA_09(HandleRef pThis, string type);
	...
	{
		return vtkDataObjectAlgorithm_IsA_09(GetCppThis(), type);
	}

	[DllImport("Kitware.VTK.CommonExecutionModel.Unmanaged.dll", CallingConvention = CallingConvention.Cdecl)]
	internal static extern int vtkDataObjectAlgorithm_IsTypeOf_10(string type);
	...
	{
		return vtkDataObjectAlgorithm_IsTypeOf_10(type);
	}
	...
	public new vtkDataObjectAlgorithm NewInstance()
	{
		...
		uint mteIndex = uint.MaxValue;
		uint rawRefCount = 0u;
		IntPtr intPtr = vtkDataObjectAlgorithm_NewInstance_12(GetCppThis(), ref mteStatus, ref mteIndex, ref rawRefCount);
		if (IntPtr.Zero != intPtr)
		{
			result = (vtkDataObjectAlgorithm)Methods.CreateWrappedObject(mteStatus, mteIndex, rawRefCount, intPtr, callDisposalMethod: true, out var _);
		}
	...
	{
		vtkDataObjectAlgorithm vtkDataObjectAlgorithm2 = null;
		uint mteStatus = 0u;
		uint mteIndex = uint.MaxValue;
		uint rawRefCount = 0u;
		IntPtr intPtr = vtkDataObjectAlgorithm_SafeDownCast_13(o?.GetCppThis() ?? default(HandleRef), ref mteStatus, ref mteIndex, ref rawRefCount);
		if (IntPtr.Zero != intPtr)
		{
			vtkDataObjectAlgorithm2 = (vtkDataObjectAlgorithm)Methods.CreateWrappedObject(mteStatus, mteIndex, rawRefCount, intPtr, callDisposalMethod: true, out var found);
			if (found)
			{
				vtkDataObjectAlgorithm2.Register(null);
			}
		}
		return vtkDataObjectAlgorithm2;
	}
	...
	{
		vtkDataObjectAlgorithm_SetInputData_14(GetCppThis(), arg0?.GetCppThis() ?? default(HandleRef));
	}
	...
	{
		vtkDataObjectAlgorithm_SetInputData_15(GetCppThis(), arg0, arg1?.GetCppThis() ?? default(HandleRef));
	}
	...
	{
		vtkDataObjectAlgorithm_SetOutput_16(GetCppThis(), d?.GetCppThis() ?? default(HandleRef));
	}
}
