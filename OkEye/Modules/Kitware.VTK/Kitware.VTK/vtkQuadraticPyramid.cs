...
public class vtkQuadraticPyramid : vtkNonLinearCell
{
	...
	{
		MRClassNameKey = "class vtkQuadraticPyramid";
		Methods.RegisterType(Assembly.GetExecutingAssembly(), MRClassNameKey, Type.GetType("Kitware.VTK.vtkQuadraticPyramid"));
	}
	...
	/// </summary>
	public vtkQuadraticPyramid(IntPtr rawCppThis, bool callDisposalMethod, bool strong)
	...
	public new static vtkQuadraticPyramid New()
	{
		...
		uint rawRefCount = 0u;
		IntPtr intPtr = vtkQuadraticPyramid_New(ref mteStatus, ref mteIndex, ref rawRefCount);
		if (IntPtr.Zero != intPtr)
		{
			result = (vtkQuadraticPyramid)Methods.CreateWrappedObject(mteStatus, mteIndex, rawRefCount, intPtr, callDisposalMethod: true, out var _);
		}
		return result;
	}
	...
	///             Undocumented Block
	/// </summary>
	public vtkQuadraticPyramid()
		: base(IntPtr.Zero, callDisposalMethod: false, strong: false)
	{
		uint mteStatus = 0u;
		uint mteIndex = uint.MaxValue;
		uint rawRefCount = 0u;
		IntPtr rawCppThis = vtkQuadraticPyramid_New(ref mteStatus, ref mteIndex, ref rawRefCount);
	...
	{
		return vtkQuadraticPyramid_CellBoundary_01(GetCppThis(), subId, pcoords, pts?.GetCppThis() ?? default(HandleRef));
	}
	...
	{
		vtkQuadraticPyramid_Clip_02(GetCppThis(), value, cellScalars?.GetCppThis() ?? default(HandleRef), locator?.GetCppThis() ?? default(HandleRef), tets?.GetCppThis() ?? default(HandleRef), inPd?.GetCppThis() ?? default(HandleRef), outPd?.GetCppThis() ?? default(HandleRef), inCd?.GetCppThis() ?? default(HandleRef), cellId, outCd?.GetCppThis() ?? default(HandleRef), insideOut);
	}
	...
	{
		vtkQuadraticPyramid_Derivatives_04(GetCppThis(), subId, pcoords, values, dim, derivs);
	}
	...
	{
		vtkQuadraticPyramid_EvaluateLocation_05(GetCppThis(), ref subId, pcoords, x, weights);
	}
	...
	{
		return vtkQuadraticPyramid_EvaluatePosition_06(GetCppThis(), x, closestPoint, ref subId, pcoords, ref dist2, weights);
	}
	...
	{
		return vtkQuadraticPyramid_GetCellDimension_07(GetCppThis());
	}
	...
	{
		return vtkQuadraticPyramid_GetCellType_08(GetCppThis());
	}
	...
	public override vtkCell GetEdge(int edgeId)
	{
		...
		uint mteIndex = uint.MaxValue;
		uint rawRefCount = 0u;
		IntPtr intPtr = vtkQuadraticPyramid_GetEdge_09(GetCppThis(), edgeId, ref mteStatus, ref mteIndex, ref rawRefCount);
		if (IntPtr.Zero != intPtr)
		{
	...
	{
		return vtkQuadraticPyramid_GetEdgeArray_10(edgeId);
	}
	...
	public override vtkCell GetFace(int faceId)
	{
		...
		uint mteIndex = uint.MaxValue;
		uint rawRefCount = 0u;
		IntPtr intPtr = vtkQuadraticPyramid_GetFace_11(GetCppThis(), faceId, ref mteStatus, ref mteIndex, ref rawRefCount);
		if (IntPtr.Zero != intPtr)
		{
			vtkCell2 = (vtkCell)Methods.CreateWrappedObject(mteStatus, mteIndex, rawRefCount, intPtr, callDisposalMethod: true, out var found);
			if (found)
	...
	{
		return vtkQuadraticPyramid_GetFaceArray_12(faceId);
	}
	...
	{
		return vtkQuadraticPyramid_GetNumberOfEdges_13(GetCppThis());
	}
	...
	{
		return vtkQuadraticPyramid_GetNumberOfFaces_14(GetCppThis());
	}

	[DllImport("Kitware.VTK.CommonDataModel.Unmanaged.dll", CallingConvention = CallingConvention.Cdecl)]
	internal static extern long vtkQuadraticPyramid_GetNumberOfGenerationsFromBase_15(HandleRef pThis, string type);
	...
	{
		return vtkQuadraticPyramid_GetNumberOfGenerationsFromBase_15(GetCppThis(), type);
	}

	[DllImport("Kitware.VTK.CommonDataModel.Unmanaged.dll", CallingConvention = CallingConvention.Cdecl)]
	internal static extern long vtkQuadraticPyramid_GetNumberOfGenerationsFromBaseType_16(string type);
	...
	{
		return vtkQuadraticPyramid_GetNumberOfGenerationsFromBaseType_16(type);
	}
	...
	{
		return vtkQuadraticPyramid_GetParametricCenter_17(GetCppThis(), pcoords);
	}
	...
	{
		return vtkQuadraticPyramid_GetParametricCoords_18(GetCppThis());
	}
	...
	{
		vtkQuadraticPyramid_InterpolateDerivs_19(GetCppThis(), pcoords, derivs);
	}
	...
	{
		vtkQuadraticPyramid_InterpolateFunctions_20(GetCppThis(), pcoords, weights);
	}
	...
	{
		vtkQuadraticPyramid_InterpolationDerivs_21(pcoords, derivs);
	}
	...
	{
		vtkQuadraticPyramid_InterpolationFunctions_22(pcoords, weights);
	}
	...
	{
		return vtkQuadraticPyramid_IntersectWithLine_23(GetCppThis(), p1, p2, tol, ref t, x, pcoords, ref subId);
	}

	[DllImport("Kitware.VTK.CommonDataModel.Unmanaged.dll", CallingConvention = CallingConvention.Cdecl)]
	internal static extern int vtkQuadraticPyramid_IsA_24(HandleRef pThis, string type);
	...
	{
		return vtkQuadraticPyramid_IsA_24(GetCppThis(), type);
	}

	[DllImport("Kitware.VTK.CommonDataModel.Unmanaged.dll", CallingConvention = CallingConvention.Cdecl)]
	internal static extern int vtkQuadraticPyramid_IsTypeOf_25(string type);
	...
	{
		return vtkQuadraticPyramid_IsTypeOf_25(type);
	}
	...
	public new vtkQuadraticPyramid NewInstance()
	{
		...
		uint mteIndex = uint.MaxValue;
		uint rawRefCount = 0u;
		IntPtr intPtr = vtkQuadraticPyramid_NewInstance_27(GetCppThis(), ref mteStatus, ref mteIndex, ref rawRefCount);
		if (IntPtr.Zero != intPtr)
		{
			result = (vtkQuadraticPyramid)Methods.CreateWrappedObject(mteStatus, mteIndex, rawRefCount, intPtr, callDisposalMethod: true, out var _);
		}
	...
	{
		vtkQuadraticPyramid vtkQuadraticPyramid2 = null;
		uint mteStatus = 0u;
		uint mteIndex = uint.MaxValue;
		uint rawRefCount = 0u;
		IntPtr intPtr = vtkQuadraticPyramid_SafeDownCast_28(o?.GetCppThis() ?? default(HandleRef), ref mteStatus, ref mteIndex, ref rawRefCount);
		if (IntPtr.Zero != intPtr)
		{
			vtkQuadraticPyramid2 = (vtkQuadraticPyramid)Methods.CreateWrappedObject(mteStatus, mteIndex, rawRefCount, intPtr, callDisposalMethod: true, out var found);
			if (found)
			{
				vtkQuadraticPyramid2.Register(null);
			}
		}
		return vtkQuadraticPyramid2;
	}

	[DllImport("Kitware.VTK.CommonDataModel.Unmanaged.dll", CallingConvention = CallingConvention.Cdecl)]
	internal static extern int vtkQuadraticPyramid_Triangulate_29(HandleRef pThis, int index, HandleRef ptIds, HandleRef pts);
	...
	{
		return vtkQuadraticPyramid_Triangulate_29(GetCppThis(), index, ptIds?.GetCppThis() ?? default(HandleRef), pts?.GetCppThis() ?? default(HandleRef));
	}
}
