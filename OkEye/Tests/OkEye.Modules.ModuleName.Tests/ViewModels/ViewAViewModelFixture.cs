using Moq;
using OkEye.Modules.ModuleName.ViewModels;
using OkEye.Services.Interfaces;
using Prism.Regions;
using Xunit;

namespace OkEye.Modules.ModuleName.Tests.ViewModels
{
    public class ViewAViewModelFixture
    {
        ...
        {
            var vm = new ViewDeviceViewModel(_regionManagerMock.Object, _messageServiceMock.Object);
