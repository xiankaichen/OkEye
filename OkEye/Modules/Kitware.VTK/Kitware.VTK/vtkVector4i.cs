...
public class vtkVector4i : WrappedObject
{
	...
	static vtkVector4i()
	{
		MRClassNameKey = "class vtkVector4i";
		Methods.RegisterType(Assembly.GetExecutingAssembly(), MRClassNameKey, Type.GetType("Kitware.VTK.vtkVector4i"));
	}
	...
	/// </summary>
	public vtkVector4i(IntPtr rawCppThis, bool callDisposalMethod, bool strong)
	...
	{
		return vtkVector4i_Normalized_01(GetCppThis());
	}
}
