...
public class vtkUnstructuredGridAlgorithm : vtkAlgorithm
{
	...
	{
		MRClassNameKey = "class vtkUnstructuredGridAlgorithm";
		Methods.RegisterType(Assembly.GetExecutingAssembly(), MRClassNameKey, Type.GetType("Kitware.VTK.vtkUnstructuredGridAlgorithm"));
	}
	...
	/// </summary>
	public vtkUnstructuredGridAlgorithm(IntPtr rawCppThis, bool callDisposalMethod, bool strong)
	...
	public new static vtkUnstructuredGridAlgorithm New()
	{
		...
		uint rawRefCount = 0u;
		IntPtr intPtr = vtkUnstructuredGridAlgorithm_New(ref mteStatus, ref mteIndex, ref rawRefCount);
		if (IntPtr.Zero != intPtr)
		{
			result = (vtkUnstructuredGridAlgorithm)Methods.CreateWrappedObject(mteStatus, mteIndex, rawRefCount, intPtr, callDisposalMethod: true, out var _);
		}
		return result;
	}
		...
		: base(IntPtr.Zero, callDisposalMethod: false, strong: false)
	{
		...
		uint mteIndex = uint.MaxValue;
		uint rawRefCount = 0u;
		IntPtr rawCppThis = vtkUnstructuredGridAlgorithm_New(ref mteStatus, ref mteIndex, ref rawRefCount);
	...
	{
		vtkUnstructuredGridAlgorithm_AddInputData_01(GetCppThis(), arg0?.GetCppThis() ?? default(HandleRef));
	}
	...
	{
		vtkUnstructuredGridAlgorithm_AddInputData_02(GetCppThis(), arg0, arg1?.GetCppThis() ?? default(HandleRef));
	}
	...
	public vtkDataObject GetInput(int port)
	{
		...
		uint mteIndex = uint.MaxValue;
		uint rawRefCount = 0u;
		IntPtr intPtr = vtkUnstructuredGridAlgorithm_GetInput_03(GetCppThis(), port, ref mteStatus, ref mteIndex, ref rawRefCount);
		if (IntPtr.Zero != intPtr)
		{
	...
	public vtkDataObject GetInput()
	{
		...
		uint mteIndex = uint.MaxValue;
		uint rawRefCount = 0u;
		IntPtr intPtr = vtkUnstructuredGridAlgorithm_GetInput_04(GetCppThis(), ref mteStatus, ref mteIndex, ref rawRefCount);
		if (IntPtr.Zero != intPtr)
		{
			vtkDataObject2 = (vtkDataObject)Methods.CreateWrappedObject(mteStatus, mteIndex, rawRefCount, intPtr, callDisposalMethod: true, out var found);
			if (found)
	...
	[DllImport("Kitware.VTK.CommonExecutionModel.Unmanaged.dll", CallingConvention = CallingConvention.Cdecl)]
	internal static extern long vtkUnstructuredGridAlgorithm_GetNumberOfGenerationsFromBase_05(HandleRef pThis, string type);
	...
	{
		return vtkUnstructuredGridAlgorithm_GetNumberOfGenerationsFromBase_05(GetCppThis(), type);
	}

	[DllImport("Kitware.VTK.CommonExecutionModel.Unmanaged.dll", CallingConvention = CallingConvention.Cdecl)]
	internal static extern long vtkUnstructuredGridAlgorithm_GetNumberOfGenerationsFromBaseType_06(string type);
	...
	{
		return vtkUnstructuredGridAlgorithm_GetNumberOfGenerationsFromBaseType_06(type);
	}
	...
	public vtkUnstructuredGrid GetOutput()
	{
		...
		uint mteIndex = uint.MaxValue;
		uint rawRefCount = 0u;
		IntPtr intPtr = vtkUnstructuredGridAlgorithm_GetOutput_07(GetCppThis(), ref mteStatus, ref mteIndex, ref rawRefCount);
		if (IntPtr.Zero != intPtr)
		{
	...
	public vtkUnstructuredGrid GetOutput(int arg0)
	{
		...
		uint mteIndex = uint.MaxValue;
		uint rawRefCount = 0u;
		IntPtr intPtr = vtkUnstructuredGridAlgorithm_GetOutput_08(GetCppThis(), arg0, ref mteStatus, ref mteIndex, ref rawRefCount);
		if (IntPtr.Zero != intPtr)
		{
			vtkUnstructuredGrid2 = (vtkUnstructuredGrid)Methods.CreateWrappedObject(mteStatus, mteIndex, rawRefCount, intPtr, callDisposalMethod: true, out var found);
			if (found)
	...
	public vtkUnstructuredGrid GetUnstructuredGridInput(int port)
	{
		...
		uint mteIndex = uint.MaxValue;
		uint rawRefCount = 0u;
		IntPtr intPtr = vtkUnstructuredGridAlgorithm_GetUnstructuredGridInput_09(GetCppThis(), port, ref mteStatus, ref mteIndex, ref rawRefCount);
		if (IntPtr.Zero != intPtr)
		{
			vtkUnstructuredGrid2 = (vtkUnstructuredGrid)Methods.CreateWrappedObject(mteStatus, mteIndex, rawRefCount, intPtr, callDisposalMethod: true, out var found);
			if (found)
	...
	[DllImport("Kitware.VTK.CommonExecutionModel.Unmanaged.dll", CallingConvention = CallingConvention.Cdecl)]
	internal static extern int vtkUnstructuredGridAlgorithm_IsA_10(HandleRef pThis, string type);
	...
	{
		return vtkUnstructuredGridAlgorithm_IsA_10(GetCppThis(), type);
	}

	[DllImport("Kitware.VTK.CommonExecutionModel.Unmanaged.dll", CallingConvention = CallingConvention.Cdecl)]
	internal static extern int vtkUnstructuredGridAlgorithm_IsTypeOf_11(string type);
	...
	{
		return vtkUnstructuredGridAlgorithm_IsTypeOf_11(type);
	}
	...
	public new vtkUnstructuredGridAlgorithm NewInstance()
	{
		...
		uint mteIndex = uint.MaxValue;
		uint rawRefCount = 0u;
		IntPtr intPtr = vtkUnstructuredGridAlgorithm_NewInstance_13(GetCppThis(), ref mteStatus, ref mteIndex, ref rawRefCount);
		if (IntPtr.Zero != intPtr)
		{
			result = (vtkUnstructuredGridAlgorithm)Methods.CreateWrappedObject(mteStatus, mteIndex, rawRefCount, intPtr, callDisposalMethod: true, out var _);
		}
	...
	{
		vtkUnstructuredGridAlgorithm vtkUnstructuredGridAlgorithm2 = null;
		uint mteStatus = 0u;
		uint mteIndex = uint.MaxValue;
		uint rawRefCount = 0u;
		IntPtr intPtr = vtkUnstructuredGridAlgorithm_SafeDownCast_14(o?.GetCppThis() ?? default(HandleRef), ref mteStatus, ref mteIndex, ref rawRefCount);
		if (IntPtr.Zero != intPtr)
		{
			vtkUnstructuredGridAlgorithm2 = (vtkUnstructuredGridAlgorithm)Methods.CreateWrappedObject(mteStatus, mteIndex, rawRefCount, intPtr, callDisposalMethod: true, out var found);
			if (found)
			{
				vtkUnstructuredGridAlgorithm2.Register(null);
			}
		}
		return vtkUnstructuredGridAlgorithm2;
	}
	...
	{
		vtkUnstructuredGridAlgorithm_SetInputData_15(GetCppThis(), arg0?.GetCppThis() ?? default(HandleRef));
	}
	...
	{
		vtkUnstructuredGridAlgorithm_SetInputData_16(GetCppThis(), arg0, arg1?.GetCppThis() ?? default(HandleRef));
	}
	...
	{
		vtkUnstructuredGridAlgorithm_SetOutput_17(GetCppThis(), d?.GetCppThis() ?? default(HandleRef));
	}
}
