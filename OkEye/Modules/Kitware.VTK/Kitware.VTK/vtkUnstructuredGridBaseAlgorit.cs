...
public class vtkUnstructuredGridBaseAlgorithm : vtkAlgorithm
{
	...
	{
		MRClassNameKey = "class vtkUnstructuredGridBaseAlgorithm";
		Methods.RegisterType(Assembly.GetExecutingAssembly(), MRClassNameKey, Type.GetType("Kitware.VTK.vtkUnstructuredGridBaseAlgorithm"));
	}
	...
	/// </summary>
	public vtkUnstructuredGridBaseAlgorithm(IntPtr rawCppThis, bool callDisposalMethod, bool strong)
	...
	public new static vtkUnstructuredGridBaseAlgorithm New()
	{
		...
		uint rawRefCount = 0u;
		IntPtr intPtr = vtkUnstructuredGridBaseAlgorithm_New(ref mteStatus, ref mteIndex, ref rawRefCount);
		if (IntPtr.Zero != intPtr)
		{
			result = (vtkUnstructuredGridBaseAlgorithm)Methods.CreateWrappedObject(mteStatus, mteIndex, rawRefCount, intPtr, callDisposalMethod: true, out var _);
		}
		return result;
	}
		...
		: base(IntPtr.Zero, callDisposalMethod: false, strong: false)
	{
		...
		uint mteIndex = uint.MaxValue;
		uint rawRefCount = 0u;
		IntPtr rawCppThis = vtkUnstructuredGridBaseAlgorithm_New(ref mteStatus, ref mteIndex, ref rawRefCount);
	...
	{
		vtkUnstructuredGridBaseAlgorithm_AddInputData_01(GetCppThis(), arg0?.GetCppThis() ?? default(HandleRef));
	}
	...
	{
		vtkUnstructuredGridBaseAlgorithm_AddInputData_02(GetCppThis(), arg0, arg1?.GetCppThis() ?? default(HandleRef));
	}

	[DllImport("Kitware.VTK.CommonExecutionModel.Unmanaged.dll", CallingConvention = CallingConvention.Cdecl)]
	internal static extern long vtkUnstructuredGridBaseAlgorithm_GetNumberOfGenerationsFromBase_03(HandleRef pThis, string type);
	...
	{
		return vtkUnstructuredGridBaseAlgorithm_GetNumberOfGenerationsFromBase_03(GetCppThis(), type);
	}

	[DllImport("Kitware.VTK.CommonExecutionModel.Unmanaged.dll", CallingConvention = CallingConvention.Cdecl)]
	internal static extern long vtkUnstructuredGridBaseAlgorithm_GetNumberOfGenerationsFromBaseType_04(string type);
	...
	{
		return vtkUnstructuredGridBaseAlgorithm_GetNumberOfGenerationsFromBaseType_04(type);
	}
	...
	public vtkUnstructuredGridBase GetOutput()
	{
		...
		uint mteIndex = uint.MaxValue;
		uint rawRefCount = 0u;
		IntPtr intPtr = vtkUnstructuredGridBaseAlgorithm_GetOutput_05(GetCppThis(), ref mteStatus, ref mteIndex, ref rawRefCount);
		if (IntPtr.Zero != intPtr)
		{
	...
	public vtkUnstructuredGridBase GetOutput(int arg0)
	{
		...
		uint mteIndex = uint.MaxValue;
		uint rawRefCount = 0u;
		IntPtr intPtr = vtkUnstructuredGridBaseAlgorithm_GetOutput_06(GetCppThis(), arg0, ref mteStatus, ref mteIndex, ref rawRefCount);
		if (IntPtr.Zero != intPtr)
		{
			vtkUnstructuredGridBase2 = (vtkUnstructuredGridBase)Methods.CreateWrappedObject(mteStatus, mteIndex, rawRefCount, intPtr, callDisposalMethod: true, out var found);
			if (found)
	...
	[DllImport("Kitware.VTK.CommonExecutionModel.Unmanaged.dll", CallingConvention = CallingConvention.Cdecl)]
	internal static extern int vtkUnstructuredGridBaseAlgorithm_IsA_07(HandleRef pThis, string type);
	...
	{
		return vtkUnstructuredGridBaseAlgorithm_IsA_07(GetCppThis(), type);
	}

	[DllImport("Kitware.VTK.CommonExecutionModel.Unmanaged.dll", CallingConvention = CallingConvention.Cdecl)]
	internal static extern int vtkUnstructuredGridBaseAlgorithm_IsTypeOf_08(string type);
	...
	{
		return vtkUnstructuredGridBaseAlgorithm_IsTypeOf_08(type);
	}
	...
	public new vtkUnstructuredGridBaseAlgorithm NewInstance()
	{
		...
		uint mteIndex = uint.MaxValue;
		uint rawRefCount = 0u;
		IntPtr intPtr = vtkUnstructuredGridBaseAlgorithm_NewInstance_10(GetCppThis(), ref mteStatus, ref mteIndex, ref rawRefCount);
		if (IntPtr.Zero != intPtr)
		{
			result = (vtkUnstructuredGridBaseAlgorithm)Methods.CreateWrappedObject(mteStatus, mteIndex, rawRefCount, intPtr, callDisposalMethod: true, out var _);
		}
	...
	{
		vtkUnstructuredGridBaseAlgorithm vtkUnstructuredGridBaseAlgorithm2 = null;
		uint mteStatus = 0u;
		uint mteIndex = uint.MaxValue;
		uint rawRefCount = 0u;
		IntPtr intPtr = vtkUnstructuredGridBaseAlgorithm_SafeDownCast_11(o?.GetCppThis() ?? default(HandleRef), ref mteStatus, ref mteIndex, ref rawRefCount);
		if (IntPtr.Zero != intPtr)
		{
			vtkUnstructuredGridBaseAlgorithm2 = (vtkUnstructuredGridBaseAlgorithm)Methods.CreateWrappedObject(mteStatus, mteIndex, rawRefCount, intPtr, callDisposalMethod: true, out var found);
			if (found)
			{
				vtkUnstructuredGridBaseAlgorithm2.Register(null);
			}
		}
		return vtkUnstructuredGridBaseAlgorithm2;
	}
	...
	{
		vtkUnstructuredGridBaseAlgorithm_SetInputData_12(GetCppThis(), arg0?.GetCppThis() ?? default(HandleRef));
	}
	...
	{
		vtkUnstructuredGridBaseAlgorithm_SetInputData_13(GetCppThis(), arg0, arg1?.GetCppThis() ?? default(HandleRef));
	}
	...
	{
		vtkUnstructuredGridBaseAlgorithm_SetOutput_14(GetCppThis(), d?.GetCppThis() ?? default(HandleRef));
	}
}
